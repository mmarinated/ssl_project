...
def compute_ats_bounding_boxes(pred_boxes_p24, targ_boxes_t24):
    """
    Computes average threat score (TS) for BBs task.
    
    Overlap thresholds for which average TS is calculated: [0.5, 0.6, 0.7, 0.8, 0.9]
    """
...
def compute_ts_road_map(road_map1, road_map2):
    """
    Computes threat score (TS) for road layout task.
    """
