...
class ModelLoader():
    ...
    def __init__(self, model_file='/scratch/sc6957/dlproject/checkpoints/team_MAPS_final_checkpoint.pth.tar'):
        # You should 
    ...
    def get_bounding_boxes(self, samples):
        ...
        for i in range(out.size()[0]):
            bbs.append(get_bounding_boxes_from_seg(out[i] > 0.5, 10, 800, 800))
    ...
    def get_binary_road_map(self, samples):
        ...
        return self.road_model(samples, is_training=False)[0] > 0.5
